...
# Función para exportar la tabla 'velocidades_maximas' a GeoJSON
...
# Exportar la tabla 'velocidades_maximas' a un archivo GeoJSON
export_to_geojson('velocidades_maximas', 'geometry', './Archivos_exportados/velocidades_maximas.geojson', extra_columns=['geojson_id', 'maxspeed'])
