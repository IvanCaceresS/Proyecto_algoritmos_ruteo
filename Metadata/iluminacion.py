...
# Consulta a Overpass API para obtener datos de iluminación en carreteras
overpass_query = f"""
[out:json][timeout:25];
(
...
if response.status_code == 200:
    ...
    print("Archivo GeoJSON guardado exitosamente con las líneas de iluminación contenidas en los polígonos.")
else:
